...
//         public static Vector4 Rotate(Rotor4 r, Vector4 v)
//         {
//             Rotor4 vRotor = new(0, new Bivector4(v.X, v.Y, v.Z, v.W, 0, 0), new Quadvector4(0));
//             Rotor4 rotated = r * vRotor * ~r;

//             return new Vector4(rotated.B.XY, rotated.B.XZ, rotated.B.XW, rotated.B.YZ);
//         }
...
//         {
//             var x = Rotate(this, Vector4.Right);
//             var y = Rotate(this, Vector4.Up);
//             var z = Rotate(this, -Vector4.Forward);
//             var w = Rotate(this, Vector4.Ana);
